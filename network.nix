...
let
  ...
  hosts = {
    ...
    qube = { ip = "192.168.73.4"; mac = "8e:e4:dc:57:ed:0a"; cnames = [ "mrtg" "whatsup" "wasgeht" "grafana" "telemetry" "dev-scale-simulator" "dev-scale-signs" ]; };
    ...
    watson = { ip = "192.168.73.11"; mac = "f6:8c:de:0f:88:f7"; cnames = [ "ai" ]; };
